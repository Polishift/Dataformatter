...
{
    public class ConstituencyElectionModelFactory : ICsvModelFactory<ConstituencyElectionModel>
    {
        //Indexes
        ...
        public ConstituencyElectionModel Create(List<string> csvDataRow)
        {
            ...
            return new ConstituencyElectionModel
            {
                ...
                TotalAmountOfVotes =
                    int.Parse(filteredCsvDataRow[TotalvotesamountColumnIndex], CultureInfo.InvariantCulture),
                AmountOfPartyVotes = double.Parse(filteredCsvDataRow[PartyvotesamountColumnIndex],
